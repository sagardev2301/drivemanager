      ...
      >
        ...
        >
          <div className="flex justify-center pt-3 pb-1">
            <div className="w-10 h-1 rounded-full bg-[#e1e8fd]" />
          </div>

          <div className="flex items-center gap-3 px-5 py-4 border-b border-[#f1f3ff]">
            <div className="w-12 h-12 rounded-full bg-[#003fb1] text-white flex items-center justify-center text-[16px] font-bold shrink-0">
              {getInitials(customer.full_name)}
            </div>
            <div className="min-w-0 flex-1">
              <p className="text-[16px] font-semibold text-[#141b2b] truncate">{customer.full_name}</p>
              <p className="text-[12px] text-[#434654]">{customer.phone_number}</p>
            </div>
            {hasPending ? (
              <span className="px-2.5 py-1 rounded-full bg-[#ffdad6] text-[#ba1a1a] text-[12px] font-semibold shrink-0">
                Rs.{customer.amount_pending.toLocaleString('en-IN')} Pending
              </span>
            ) : (
              <span className="px-2.5 py-1 rounded-full bg-[#6bff8f]/30 text-[#005623] text-[12px] font-semibold shrink-0">
                Paid
              </span>
            )}
          </div>
          ...
          <div className="flex flex-col gap-2 px-5 pt-4">
            <button
              ...
              disabled={!hasPending}
              className={'w-full flex items-center gap-3 px-4 py-3.5 rounded-2xl text-left transition-all active:scale-[0.98] ' + (hasPending ? 'bg-[#003fb1] text-white shadow-sm' : 'bg-[#f1f3ff] text-[#737686] opacity-60 cursor-not-allowed')}
            >
            ...
            <button
              ...
              className={'w-full flex items-center gap-3 px-4 py-3.5 rounded-2xl text-left transition-all active:scale-[0.98] ' + (hasPhone && hasPending ? 'bg-[#e8f5e9] text-[#1b5e20]' : 'bg-[#f1f3ff] text-[#737686] opacity-60 cursor-not-allowed')}
            >
            ...
            <button
              ...
              className="w-full flex items-center gap-3 px-4 py-3.5 rounded-2xl bg-[#f1f3ff] text-[#141b2b] text-left transition-all active:scale-[0.98]"
            >
              ...
              <span className="material-symbols-outlined text-[18px] text-[#737686] ml-auto">chevron_right</span>
            </button>
          </div>
        </div>
      </div>
