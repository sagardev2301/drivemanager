...
import DeleteClassConfirmModal from '../components/DeleteClassConfirmModal'
    ...
    >
      ...
      {classToDelete && (
        <DeleteClassConfirmModal
          ...
          onConfirm={() => handleDeleteClass(classToDelete.id)}
          deleting={deletingId === classToDelete.id}
          studentName={classToDelete.full_name}
          error={deleteError}
        />
      )}
      </AnimatePresence>
